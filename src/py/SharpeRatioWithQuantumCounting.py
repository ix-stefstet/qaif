...
def main():
    ...
    while abs(s_above - s_below) > 0.01:
        ...
        number_of_solutions, upper_error_bound, measured_index = quantum_counting_with_bitstring(
            bit_string=bit_string,
            number_of_phase_estimation_qubits=number_of_phase_estimation_qubits
        )
        print('%-14s | %-14s | %-14s' % ('Measured #Sol', 'Measured Index', 'Error Bound'))
        print('%-14.1f | %-14.2f | %-14.2f' % (number_of_solutions, measured_index, upper_error_bound))
        ...
        #     bit_string = '1' * expected_number_of_solutions + '0' * (
        #                 2 ** number_of_oracle_qubits - expected_number_of_solutions)
...
def quantum_counting_with_bitstring(
    ...
    number_of_solutions, upper_error_bound, measured_index = quantum_counting_with_oracle(
        oracle=oracle,
        number_of_phase_estimation_qubits=number_of_phase_estimation_qubits
    )
    return number_of_solutions, upper_error_bound, measured_index
